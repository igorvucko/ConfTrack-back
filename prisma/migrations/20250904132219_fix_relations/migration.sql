/*
  ...
  - You are about to drop the column `festivalId` on the `Review` table. All the data in the column will be lost.
  - You are about to drop the `Festival` table. If the table is not empty, all the data it contains will be lost.
  - Added the required column `conferenceId` to the `Review` table without a default value. This is not possible if the table is not empty.

*/
-- DropForeignKey
ALTER TABLE "Review" DROP CONSTRAINT "Review_festivalId_fkey";

-- AlterTable
ALTER TABLE "Review" DROP COLUMN "festivalId",
ADD COLUMN     "conferenceId" INTEGER NOT NULL;
